...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'exhibit_publishedexhibit', ['owner_id', 'slug'])

        # Deleting field 'PublishedExhibit.owner'
        db.delete_column(u'exhibit_publishedexhibit', 'owner_id')

        # Deleting field 'PublishedExhibit.slug'
        db.delete_column(u'exhibit_publishedexhibit', 'slug')

        # Deleting field 'DraftExhibit.owner'
        db.delete_column(u'exhibit_draftexhibit', 'owner_id')


    def backwards(self, orm):
        # Adding field 'PublishedExhibit.owner'
        db.add_column(u'exhibit_publishedexhibit', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='published_exhibits', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Adding field 'PublishedExhibit.slug'
        db.add_column(u'exhibit_publishedexhibit', 'slug',
        ...
        db.create_unique(u'exhibit_publishedexhibit', ['owner_id', 'slug'])

        # Adding field 'DraftExhibit.owner'
        db.add_column(u'exhibit_draftexhibit', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='draft_exhibits', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)
