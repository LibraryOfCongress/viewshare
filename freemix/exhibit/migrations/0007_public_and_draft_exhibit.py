...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PublishedExhibit'
        db.create_table('exhibit_publishedexhibit', (
            ('exhibit_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['exhibit.Exhibit'], unique=True, primary_key=True)),
            ('is_public', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('publisher', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='published_exhibits', null=True, to=orm['auth.User'])),
            ('t', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('s', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, populate_from='title', overwrite=False)),
            ('d', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('exhibit', ['PublishedExhibit'])

        # Adding unique constraint on 'PublishedExhibit', fields ['slug', 'publisher']
        db.create_unique('exhibit_publishedexhibit', ['s', 'publisher_id'])

        # Adding model 'DraftExhibit'
        db.create_table('exhibit_draftexhibit', (
            ('exhibit_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['exhibit.Exhibit'], unique=True, primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exhibit.PublishedExhibit'], null=True, blank=True)),
        ))
        db.send_create_signal('exhibit', ['DraftExhibit'])


    def backwards(self, orm):
        # Removing unique constraint on 'PublishedExhibit', fields ['slug', 'publisher']
        db.delete_unique('exhibit_publishedexhibit', ['slug', 'publisher_id'])

        # Deleting model 'PublishedExhibit'
        db.delete_table('exhibit_publishedexhibit')

        # Deleting model 'DraftExhibit'
        db.delete_table('exhibit_draftexhibit')
