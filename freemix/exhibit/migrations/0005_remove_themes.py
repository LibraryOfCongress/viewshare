...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Exhibit.theme'
        db.delete_column('exhibit_exhibit', 'theme_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Exhibit.theme'
        raise RuntimeError("Cannot reverse this migration. 'Exhibit.theme' and its values cannot be restored.")
