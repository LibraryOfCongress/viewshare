...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exhibit.o'
        db.add_column(u'exhibit_exhibit', 'o',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'Exhibit.s'
        db.add_column(u'exhibit_exhibit', 's',
                      self.gf('django.db.models.fields.SlugField')(default='-', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Exhibit.is_draft'
        db.add_column(u'exhibit_exhibit', 'is_draft',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Exhibit.o'
        db.delete_column(u'exhibit_exhibit', 'o_id')

        # Deleting field 'Exhibit.s'
        db.delete_column(u'exhibit_exhibit', 's')

        # Deleting field 'Exhibit.is_draft'
        db.delete_column(u'exhibit_exhibit', 'is_draft')
