...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Dataset.profile'
        db.delete_column('dataset_dataset', 'profile')

        # Deleting field 'Dataset.data'
        db.delete_column('dataset_dataset', 'data')

        # Deleting field 'Dataset.properties_cache'
        db.delete_column('dataset_dataset', 'properties_cache')


    def backwards(self, orm):
        
        # Adding field 'Dataset.profile'
        db.add_column('dataset_dataset', 'profile', self.gf('django.db.models.fields.TextField')(default='{"properties": []}'), keep_default=False)

        # Adding field 'Dataset.data'
        db.add_column('dataset_dataset', 'data', self.gf('django.db.models.fields.TextField')(default='{"items": []}'), keep_default=False)

        # Adding field 'Dataset.properties_cache'
        db.add_column('dataset_dataset', 'properties_cache', self.gf('django.db.models.fields.TextField')(default='{"properties": {}}'), keep_default=False)
