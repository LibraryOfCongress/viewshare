...
class Migration(SchemaMigration):
    ...
    models = {
        'robots.rule': {
            ...
            'allowed': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'allowed'", 'blank': 'True', 'to': "orm['robots.Url']"}),
            'crawl_delay': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '3', 'decimal_places': '1', 'blank': 'True'}),
            'disallowed': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'disallowed'", 'blank': 'True', 'to': "orm['robots.Url']"}),
