...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OAIDataSource'
        db.create_table('upload_oaidatasource', (
            ...
            ('set', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('limit', self.gf('django.db.models.fields.IntegerField')(default='100')),
        ))
        db.send_create_signal('upload', ['OAIDataSource'])


    def backwards(self, orm):
        
        # Deleting model 'OAIDataSource'
        db.delete_table('upload_oaidatasource')
