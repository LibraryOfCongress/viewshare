...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('collection_catalog_collection', (
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collection_catalog.Project'])),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('external_view', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ))
        db.send_create_signal('collection_catalog', ['Collection'])

        # Adding M2M table for field topics on 'Collection'
        db.create_table('collection_catalog_collection_topics', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collection', models.ForeignKey(orm['collection_catalog.collection'], null=False)),
            ('topic', models.ForeignKey(orm['collection_catalog.topic'], null=False))
            ))
        db.create_unique('collection_catalog_collection_topics', ['collection_id', 'topic_id'])
        ...
        # Adding M2M table for field organizations on 'Collection'
        db.create_table('collection_catalog_collection_organizations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collection', models.ForeignKey(orm['collection_catalog.collection'], null=False)),
            ('organization', models.ForeignKey(orm['collection_catalog.organization'], null=False))
            ))
        db.create_unique('collection_catalog_collection_organizations', ['collection_id', 'organization_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field topics on 'Collection'
        db.delete_table('collection_catalog_collection_topics')

        # Removing M2M table for field exhibits on 'Collection'
        db.delete_table('collection_catalog_collection_exhibits')

        # Removing M2M table for field organizations on 'Collection'
        db.delete_table('collection_catalog_collection_organizations')
    ...
    models = {
        ...
        'collection_catalog.collection': {
            ...
            'exhibits': ('django.db.models.fields.related.ManyToManyField', [],
                         {'to': "orm['exhibit.Exhibit']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'organizations': ('django.db.models.fields.related.ManyToManyField', [],
                              {'to': "orm['collection_catalog.Organization']", 'symmetrical': 'False'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['collection_catalog.Project']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '100'}),
            'thumbnail': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'topics': (
            'django.db.models.fields.related.ManyToManyField', [], {'to': "orm['collection_catalog.Topic']", 'symmetrical': 'False'})
        },
        ...
        'dataset.dataset': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'datasets'", 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'exhibit.exhibit': {
            ...
            'dataset': ('django.db.models.fields.related.ForeignKey', [],
                        {'blank': 'True', 'related_name': "'exhibits'", 'null': 'True', 'to': "orm['dataset.Dataset']"}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [],
                      {'blank': 'True', 'related_name': "'exhibits'", 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'exhibit.theme': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'blank': 'True'}),
            'thumbnail': ('django.db.models.fields.files.ImageField', [],
