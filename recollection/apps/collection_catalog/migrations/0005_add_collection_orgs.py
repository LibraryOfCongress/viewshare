...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding ManyToManyField 'Collection.organizations'
    ...
    def backwards(self, orm):
        ...
        # Dropping ManyToManyField 'Collection.organizations'
    ...
    models = {
        ...
        'collection_catalog.collection': {
            ...
            'organizations': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['collection_catalog.Organization']", 'blank': 'True'}),
