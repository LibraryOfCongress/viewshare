...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('collection_catalog_topic', 'description', orm['collection_catalog.topic:description'])
        
        # Changing field 'Topic.slug'
        # (to signature: django.db.models.fields.SlugField(unique=True, max_length=100, db_index=True))
        db.alter_column('collection_catalog_topic', 'slug', orm['collection_catalog.topic:slug'])
        
        # Changing field 'Organization.slug'
        # (to signature: django.db.models.fields.SlugField(unique=True, max_length=100, db_index=True))
        db.alter_column('collection_catalog_organization', 'slug', orm['collection_catalog.organization:slug'])
        
        # Changing field 'Project.slug'
        # (to signature: django.db.models.fields.SlugField(unique=True, max_length=100, db_index=True))
        db.alter_column('collection_catalog_project', 'slug', orm['collection_catalog.project:slug'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('collection_catalog_topic', 'description')
        
        # Changing field 'Topic.slug'
        # (to signature: django.db.models.fields.SlugField(max_length=30, unique=True, db_index=True))
        db.alter_column('collection_catalog_topic', 'slug', orm['collection_catalog.topic:slug'])
