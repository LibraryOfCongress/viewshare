...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding ManyToManyField 'Collection.topics'
        ...
        db.delete_column('collection_catalog_collection', 'topic_id')
        
    
    
    def backwards(self, orm):
        
        # Dropping ManyToManyField 'Collection.topics'
        db.delete_table('collection_catalog_collection_topics')
        
        # Adding field 'Collection.topic'
        db.add_column('collection_catalog_collection', 'topic', orm['collection_catalog.collection:topic'])
