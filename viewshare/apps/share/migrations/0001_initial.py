...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SharedExhibitKey'
        db.create_table('share_sharedexhibitkey', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('label', self.gf('django.db.models.fields.TextField')(max_length=255, null=True, blank=True)),
            ('exhibit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exhibit.Exhibit'])),
        ))
        db.send_create_signal('share', ['SharedExhibitKey'])


    def backwards(self, orm):
        
        # Deleting model 'SharedExhibitKey'
        db.delete_table('share_sharedexhibitkey')
