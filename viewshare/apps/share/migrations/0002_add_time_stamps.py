...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SharedExhibitKey.created'
        db.add_column('share_sharedexhibitkey', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)

        # Adding field 'SharedExhibitKey.modified'
        db.add_column('share_sharedexhibitkey', 'modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SharedExhibitKey.created'
        db.delete_column('share_sharedexhibitkey', 'created')

        # Deleting field 'SharedExhibitKey.modified'
        db.delete_column('share_sharedexhibitkey', 'modified')
    ...
    models = {
        ...
        'share.sharedexhibitkey': {
            'Meta': {'object_name': 'SharedExhibitKey'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'exhibit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shared_keys'", 'to': "orm['exhibit.Exhibit']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
