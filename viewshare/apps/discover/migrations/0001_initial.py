...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CuratedExhibitCollection'
        db.create_table('discover_curatedexhibitcollection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=75)),
        ))
        db.send_create_signal('discover', ['CuratedExhibitCollection'])

        # Adding model 'CuratedExhibit'
        db.create_table('discover_curatedexhibit', (
            ('primary_id', self.gf('django.db.models.fields.AutoField')(primary_key=True, db_column='id')),
            ('position', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('custom_title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('publish_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['discover.CuratedExhibitCollection'])),
            ('thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('exhibit', self.gf('curation.fields.CuratedForeignKey')(to=orm['exhibit.Exhibit'])),
        ))
        db.send_create_signal('discover', ['CuratedExhibit'])


    def backwards(self, orm):
        # Deleting model 'CuratedExhibitCollection'
        db.delete_table('discover_curatedexhibitcollection')

        # Deleting model 'CuratedExhibit'
        db.delete_table('discover_curatedexhibit')
    ...
    models = {
        ...
        'discover.curatedexhibit': {
            'Meta': {'ordering': "['position']", 'object_name': 'CuratedExhibit'},
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['discover.CuratedExhibitCollection']"}),
            'custom_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'exhibit': ('curation.fields.CuratedForeignKey', [], {'to': "orm['exhibit.Exhibit']"}),
            'position': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'primary_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True', 'db_column': "'id'"}),
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'thumbnail': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'})
        },
        'discover.curatedexhibitcollection': {
            'Meta': {'object_name': 'CuratedExhibitCollection'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
