...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReferenceDataSource'
        db.create_table('upload_referencedatasource', (
            ...
            ('referenced', self.gf('django.db.models.fields.related.ForeignKey')(related_name='references', to=orm['exhibit.Exhibit'])),
        ))
        db.send_create_signal('upload', ['ReferenceDataSource'])


    def backwards(self, orm):
        # Deleting model 'ReferenceDataSource'
        db.delete_table('upload_referencedatasource')
    ...
    models = {
        ...
        'upload.datasource': {
            ...
            'classname': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'exhibit': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'source'", 'unique': 'True', 'to': "orm['exhibit.Exhibit']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'})
        },
        ...
        'upload.referencedatasource': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'ReferenceDataSource', '_ormbases': ['dataset.DataSource']},
            'datasource_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['dataset.DataSource']", 'unique': 'True', 'primary_key': 'True'}),
            'referenced': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'references'", 'to': "orm['exhibit.Exhibit']"})
        },
