...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("exhibit", "0014_populate_profile"),
    )


    def forwards(self, orm):
        # Adding model 'DataSource'
        db.create_table('upload_datasource', (
            ...
            ('exhibit', self.gf('django.db.models.fields.related.OneToOneField')(related_name='source', unique=True, to=orm['exhibit.Exhibit'])),
        ))
        db.send_create_signal('upload', ['DataSource'])


    def backwards(self, orm):
        # Deleting model 'DataSource'
        db.delete_table('upload_datasource')
