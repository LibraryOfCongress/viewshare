...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModsURLDataSource.new_ds_ptr'
        db.add_column(u'upload_modsurldatasource', 'new_ds_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['upload.DataSource'], unique=True, null=True),
                      keep_default=False)

        # Adding field 'OAIDataSource.new_ds_ptr'
        db.add_column(u'upload_oaidatasource', 'new_ds_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['upload.DataSource'], unique=True, null=True),
                      keep_default=False)

        # Adding field 'URLDataSource.new_ds_ptr'
        db.add_column(u'upload_urldatasource', 'new_ds_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['upload.DataSource'], unique=True, null=True),
                      keep_default=False)

        # Adding field 'JSONFileDataSource.new_ds_ptr'
        db.add_column(u'upload_jsonfiledatasource', 'new_ds_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['upload.DataSource'], unique=True, null=True),
                      keep_default=False)

        # Adding field 'ContentDMDataSource.new_ds_ptr'
        db.add_column(u'upload_contentdmdatasource', 'new_ds_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['upload.DataSource'], unique=True, null=True),
                      keep_default=False)

        # Adding field 'JSONURLDataSource.new_ds_ptr'
        db.add_column(u'upload_jsonurldatasource', 'new_ds_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['upload.DataSource'], unique=True, null=True),
                      keep_default=False)

        # Adding field 'FileDataSource.new_ds_ptr'
        db.add_column(u'upload_filedatasource', 'new_ds_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['upload.DataSource'], unique=True, null=True),
                      keep_default=False)

        # Adding field 'ModsFileDataSource.new_ds_ptr'
        db.add_column(u'upload_modsfiledatasource', 'new_ds_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['upload.DataSource'], unique=True, null=True),
                      keep_default=False)

        # Adding field 'ReferenceDataSource.new_ds_ptr'
        db.add_column(u'upload_referencedatasource', 'new_ds_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['upload.DataSource'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModsURLDataSource.new_ds_ptr'
        db.delete_column(u'upload_modsurldatasource', 'new_ds_ptr_id')

        # Deleting field 'OAIDataSource.new_ds_ptr'
        db.delete_column(u'upload_oaidatasource', 'new_ds_ptr_id')

        # Deleting field 'URLDataSource.new_ds_ptr'
        db.delete_column(u'upload_urldatasource', 'new_ds_ptr_id')

        # Deleting field 'JSONFileDataSource.new_ds_ptr'
        db.delete_column(u'upload_jsonfiledatasource', 'new_ds_ptr_id')

        # Deleting field 'ContentDMDataSource.new_ds_ptr'
        db.delete_column(u'upload_contentdmdatasource', 'new_ds_ptr_id')

        # Deleting field 'JSONURLDataSource.new_ds_ptr'
        db.delete_column(u'upload_jsonurldatasource', 'new_ds_ptr_id')

        # Deleting field 'FileDataSource.new_ds_ptr'
        db.delete_column(u'upload_filedatasource', 'new_ds_ptr_id')

        # Deleting field 'ModsFileDataSource.new_ds_ptr'
        db.delete_column(u'upload_modsfiledatasource', 'new_ds_ptr_id')

        # Deleting field 'ReferenceDataSource.new_ds_ptr'
        db.delete_column(u'upload_referencedatasource', 'new_ds_ptr_id')
    ...
    models = {
        ...
        u'upload.contentdmdatasource': {
            ...
            'new_ds_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['upload.DataSource']", 'unique': 'True', 'null': 'True'}),
