...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DraftExhibit.parent'
        db.alter_column(u'exhibit_draftexhibit', 'parent_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['exhibit.PublishedExhibit'], unique=True, null=True))
        # Adding unique constraint on 'DraftExhibit', fields ['parent']
        db.create_unique(u'exhibit_draftexhibit', ['parent_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DraftExhibit', fields ['parent']
        db.delete_unique(u'exhibit_draftexhibit', ['parent_id'])


        # Changing field 'DraftExhibit.parent'
        db.alter_column(u'exhibit_draftexhibit', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exhibit.PublishedExhibit'], null=True))
