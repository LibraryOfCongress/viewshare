...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PropertyData'
        db.create_table(u'exhibit_propertydata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('exhibit_property', self.gf('django.db.models.fields.related.OneToOneField')(related_name='data', unique=True, to=orm['exhibit.ExhibitProperty'])),
            ('json', self.gf('django.db.models.fields.TextField')(default='{}')),
        ))
        db.send_create_signal(u'exhibit', ['PropertyData'])


    def backwards(self, orm):
        # Deleting model 'PropertyData'
        db.delete_table(u'exhibit_propertydata')
