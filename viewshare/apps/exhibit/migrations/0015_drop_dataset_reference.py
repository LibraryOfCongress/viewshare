...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('upload', '0010_rename_new_ds_ptr__datasource_ptr'),
    )

    def forwards(self, orm):
        # Deleting field 'Exhibit.dataset'
        db.delete_column(u'exhibit_exhibit', 'dataset_id')


    def backwards(self, orm):
        # Adding field 'Exhibit.dataset'
        db.add_column(u'exhibit_exhibit', 'dataset',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='exhibits', null=True, to=orm['dataset.Dataset'], blank=True),
                      keep_default=False)
