...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'exhibit_canvas')

        # Deleting field 'Exhibit.canvas'
        db.delete_column(u'exhibit_exhibit', 'canvas_id')


    def backwards(self, orm):
        # Adding model 'Canvas'
        db.create_table(u'exhibit_canvas', (
            ...
            ('location', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True)),
        ))
        db.send_create_signal(u'exhibit', ['Canvas'])


        # User chose to not deal with backwards NULL issues for 'Exhibit.canvas'
        raise RuntimeError("Cannot reverse this migration. 'Exhibit.canvas' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Exhibit.canvas'
        db.add_column(u'exhibit_exhibit', 'canvas',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exhibit.Canvas']),
                      keep_default=False)
