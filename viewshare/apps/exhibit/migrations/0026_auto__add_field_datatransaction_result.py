...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataTransaction.result'
        db.add_column(u'exhibit_datatransaction', 'result',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataTransaction.result'
        db.delete_column(u'exhibit_datatransaction', 'result')
