...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExhibitProperty.name'
        db.alter_column(u'exhibit_exhibitproperty', 'name', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=255, separator='_', populate_from=('label',), overwrite=False))
        # Adding index on 'ExhibitProperty', fields ['name']
        db.create_index(u'exhibit_exhibitproperty', ['name'])


    def backwards(self, orm):
        # Removing index on 'ExhibitProperty', fields ['name']
        db.delete_index(u'exhibit_exhibitproperty', ['name'])


        # Changing field 'ExhibitProperty.name'
        db.alter_column(u'exhibit_exhibitproperty', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'exhibit.exhibitproperty': {
            ...
            'name': ('django_extensions.db.fields.AutoSlugField', [], {'allow_duplicates': 'False', 'max_length': '255', 'separator': "'_'", 'blank': 'True', 'populate_from': "('label',)", 'overwrite': 'False'}),
