...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exhibit.dataset'
        db.alter_column('exhibit_exhibit', 'dataset_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['dataset.Dataset']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Exhibit.dataset'
        raise RuntimeError("Cannot reverse this migration. 'Exhibit.dataset' and its values cannot be restored.")
