...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('dataset_dataset', 'source_id')


    def backwards(self, orm):
        
        # Adding field 'Dataset.source'
        db.add_column('dataset_dataset', 'source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='datasets', null=True, to=orm['dataset.DataSource'], blank=True), keep_default=False)
