...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataSource.dataset'
        db.add_column('dataset_datasource', 'dataset', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dataset.Dataset'], unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataSource.dataset'
        db.delete_column('dataset_datasource', 'dataset_id')
