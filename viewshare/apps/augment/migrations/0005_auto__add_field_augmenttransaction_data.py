...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AugmentTransaction.data'
        db.add_column(u'augment_augmenttransaction', 'data',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exhibit.PropertyData'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AugmentTransaction.data'
        db.delete_column(u'augment_augmenttransaction', 'data_id')
    ...
    models = {
        ...
        u'augment.augmenttransaction': {
            ...
            'data': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exhibit.PropertyData']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
